...
const Story = () => {
  return (
    <section className="bg-black text-white py-12">
        <h3 className="flex flex-center ">Our Story</h3>
      <div className="container mx-auto px-4 md:px-8 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="md:col-span-1 text-left">
            ...
            {/* <br />
            <p className="text-lg leading-relaxed">
              The debut production for the Red Chillies banner was not just a
              roaring box office hit, but also bagged its fair share of IIFA and
              Zee Cine awards. Since then, we've tasted consistent success with
              titles like Om Shanti Om, Ra.One, Chennai Express, Happy New Year,
              and Dear Zindagi. It is our continual aim to deliver content that
              garners both popular as well as critical acclaim, while making
              Indian films more visible to an international audience.
            </p> */}
          </div>
